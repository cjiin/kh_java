package 생성자기본연습;
// 생성자란 클래스가 객체로 만들어질 때 자동으로 호출(new를 호출할때)되며,
// 생성자는 인스턴스 필드를 초기화하는 것이 주 목적이다.
// 생성자 만드는 규칙
// 1. 생성자는 클래스 이름과 같아야 함
// 2. 반환타입은 없고 접근제한자는 올 수 있으나 private 은 특별한 경우가 아니면 사용 안함
...
public class ConstructorEx {
    public static void main(String[] args) {
        ...
        Car g90 = new Car("제세시스 G90", "2022", "Black");
        ev6.getCar();
        kona.getCar();
        sorento.getCar();
        g90.getCar();
