...
public class IPadProMake {
    ...
    String productDate; // 제품 생산 일자 (시리얼넘버 만들 때 사용)
    String serialNum; // 제품 일련 번호 : iPad13128C2301121
    static int cnt = 0; // 클래스 변수 : 객체 생성 되지 않고 클래스 생성 시 만들어짐
    IPadProMake(String name) {
        ...
        cnt++;  // 생성자는 객체가 만들어질 때 호출되므로 생성된 객체의 횟수를 확인하는 용도로 사용
        productDate += cnt; // 연월일 + 생산갯수
