...
// skip() : 해당 스트림의 첫번쨰 요소부터 전달된 개수 만큼의 요소를 제외하고 출력

//스트림 정렬 : 해당 스트림을 주어진 비교자를 이용하여 정렬
...
//        list.stream().filter(n->n % 2 ==0).forEach(e -> System.out.print(e + " "));
        ...
        //스트림 제한 limit(), skip()
        IntStream stream4 = IntStream.range(0, 10); //0에서 10 미만
        ...
        System.out.println();
        stream5.skip(5).forEach(n -> System.out.print(n + " ")); //처음부터 5 건너뜀
        System.out.println();
        stream6.skip(3).limit(5).forEach(n -> System.out.print(" "));
