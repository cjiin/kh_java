...
// 콘솔 입출력 : 키보드로 입력 받고 화면에 출력하는 것
// System.in : 표준 입력 스트림
// System.out : 표준 출력 스트림
// System.err : 표준 오류 스트림 ( System.out 과 거의 동일하며 버퍼 사용 방법만 다름. 더 좋은게 있어서 사용 안함)
public class ConsoleEx {
    public static void main(String[] args) throws IOException {
        System.out.println("=== 메뉴 ===");
        System.out.println("1. 에금 조회");
        System.out.println("2. 에금 출금");
        System.out.println("3. 에금 입금");
