...
// Vector 는 ArrayList 와 내부적으로 동일한 구조. 메소드의 사용 방법도 완전히 동일함. 멀티스레드에서 안전함
public class VectorEx1 {
    public static void main(String[] args) {
        List<NameCard> list = new Vector<>();
        list.add(new NameCard("우영우","010-1234-5678","yyyy@gmail.com",
                "변호사","서울시 강남구 역삼동"));
        list.add(new NameCard("동그라미","010-4343-5678","ddd@gmail.com",
                "무직","인천광역시 강화군"));
        list.add(new NameCard("이준호","010-3322-5678","eee@gmail.com",
                "사무직","서울시 서초구"));
