package 평균은넘겠지;
//        5 => 총 테스트 케이스
//        5 50 50 70 80 100 => 40.000% (학생수 성적 성적 성적 성적 성적) => 평균이 넘는 비율을 백분율로 표기
...
public class AboveAver {
    public static void main(String[] args) {
     ...
     // 학생수를 입력받고 입력 받은 학생수 만큼의 성적을 입력 받음
     ...
     static double overRate() {
         ...
         double aver = (double) total / cnt; // 총점을 학생수로 나누어 평균을 구함
